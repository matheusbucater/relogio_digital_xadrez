...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : player2_button_Pin player1_button_Pin reset_match_button_Pin */
  GPIO_InitStruct.Pin = player2_button_Pin|player1_button_Pin|reset_match_button_Pin;
